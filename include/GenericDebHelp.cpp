...
DebHelp::VerbosityLevel DebHelp::m_verbose=VL_Debug;

DebHelp::VerbosityLevel DebHelp::Verbose() {return m_verbose;};
void DebHelp::SetVerboseQuiet() {m_verbose=VL_Quiet;};
void DebHelp::SetVerboseLog() {m_verbose=VL_Log;};
void DebHelp::SetVerboseDebug() {m_verbose=VL_Debug;};
